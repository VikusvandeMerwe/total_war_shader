...
1.
 1.1	Go to "Shader" and copy everything in there.
 1.2	Open the installation folder of Substance Designer
	(should be "C:\Program Files\Allegorithmic\Substance Designer <version>").
 1.3	Go to "...\resources\view3d\shaders".
 1.4	Paste the files from the "Shader" folder there.
...
2.
 ...
 2.5	Go to "Tools" -> "Preferences".
 2.6	Click on the "Projects" tab on the left side.
 2.7	Under "Project" scroll down to "Substance Templates".
 2.8	Click "Add new path" on the right side.
 2.9	Choose your folder and add it.
 2.10	Restart Substance Designer.
